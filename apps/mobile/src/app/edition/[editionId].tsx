...
export default function EditionDetail() {
  ...
  const share = async () => {
    try { await Share.share({ title: `${place.name} · Souvenir`, message: `My ${editionStamp(edition.sequence).toLowerCase()} at ${place.name} on ${visitDate(edition.visitedAt, edition.timezone)}.${edition.moment ? ` ${edition.moment}` : ''}` }); }
