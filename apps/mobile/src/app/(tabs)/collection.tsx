...
export default function CollectionScreen() {
  ...
  return <Screen scroll={false}>
    ...
    <Sheet visible={options} onClose={() => setOptions(false)} title="Your collection"><Button label="Import memories" icon="upload" onPress={() => { setOptions(false); router.push(state.mode === 'account' ? '/memories' : '/import/dropbox'); }} />
      {state.mode === 'account' && <><Button label="Shared albums & moments" variant="outline" onPress={() => { setOptions(false); router.push('/albums'); }} /><Button label="Memory invitations" variant="outline" onPress={() => { setOptions(false); router.push('/memories/invitations'); }} /></>}
      <Button label="Favorites" variant="outline" icon="heart" onPress={() => { setOptions(false); router.push('/profile/favorites'); }} /><Button label="Private tips" variant="outline" icon="edit" onPress={() => { setOptions(false); router.push('/profile/tips'); }} /></Sheet>
