...
const container = `souvenir-social-${randomUUID()}`;
const docker = (...args) =>
...
try {
  ...
  execFileSync(
    "corepack",
    ["pnpm", "exec", "vitest", "run", "--config", "tests/server/vitest.social.config.ts"],
    { cwd: root, env, stdio: "inherit" },
  );
  execFileSync("corepack", ["pnpm", "exec", "tsx", "scripts/recompute-stats.ts"], {
    cwd: root,
    env,
    stdio: "inherit",
  });
